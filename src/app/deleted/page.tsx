      ...
      <div className="container" style={{ maxWidth: '480px', position: 'relative', zIndex: 1 }}>
        <div className="auth-card-mobile animate-spring" style={{ padding: '4rem 2.5rem', background: '#fff', textAlign: 'center' }}>
          <header style={{ marginBottom: '2.5rem' }}>
             ...
             <p style={{ color: '#94a3b8', marginTop: '0.2rem', fontSize: '0.75rem', fontWeight: 800, letterSpacing: '0.3em', textTransform: 'uppercase' }}>Account Deleted</p>
          </header>

          <div style={{ marginBottom: '3rem' }}>
            <div style={{ fontSize: '3.5rem', marginBottom: '1.5rem' }}>🍃</div>
            <h2 style={{ fontSize: '1.5rem', fontWeight: 800, color: '#0f172a', marginBottom: '1rem', letterSpacing: '-0.03em' }}>Account Successfully Deleted</h2>
            <p style={{ color: 'var(--text-dim)', fontSize: '0.95rem', lineHeight: '1.6', fontWeight: 500 }}>
              Your SoftBridge account and all associated data have been permanently deleted. Any active integrations have been disconnected.
            </p>
          </div>
